...
function showThemes(str) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("tblThemes").innerHTML = xmlhttp.responseText;
            }
        };
        xmlhttp.open("GET","settings_get_themes.php?id="+str,true);
        xmlhttp.send();
...
<div  class='box-container'  style="width:80%;overflow-x;scroll">

<a style="float:right" href="settings_theme_add.php">Add New Theme </a>
<h4 class="title">Theme </h4> 
<table class='theme' id="tblThemes">
<?php 
...
<input type="submit" name="setTheme" id="setTheme" value="Set Theme" class="buttonLink" />

<input type="submit" name="editTheme" id="editTheme" value="Edit Theme" class="buttonLink" />
...
$query = "delete from theme_user where userid=$userid";
//echo $query;

$result=mysql_query($query);

$query = "Insert into theme_user (userid, themeid, active) Values($userid, $themeid, 1)";
		
//echo $query;
		$result=mysql_query($query);
		if($result)
		echo '<br><br>Set the theme';
		
}
//settings_theme_add.php?id=1
...
echo '<script>window.location.href="settings_theme_add.php?id=' . $themeid . '";</script>';
